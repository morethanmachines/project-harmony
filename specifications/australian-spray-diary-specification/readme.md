...
| usage_restrictions	| `array` | An array of objects	Any restrictions or limitations on the use of the product, specified by type of user, reference, unit, and value. | 
